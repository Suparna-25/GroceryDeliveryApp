...
//	public ResponseEntity<Product> viewProductByCategoryName(@PathVariable String categoryName){
//		return new ResponseEntity<>(productService.viewProductByCategory(categoryName),HttpStatus.OK);
//		
//	}
